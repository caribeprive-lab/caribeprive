...
//
// IMPORTANTE: "city" NUNCA se relaja aquí a propósito. Si el usuario pidió
// una ciudad específica (cubierta por el inventario o no — Mérida, CDMX,
// Miami, o incluso Cancún), relajar la ciudad significaría sugerir un
// mercado distinto al que pidió, no una alternativa cercana a lo mismo.
// Eso empuja al chatbot a redirigir al usuario ("¿te interesaría Cancún o
// Playa del Carmen?"), que es justo el comportamiento que no queremos.
// Relajar "zone" (un vecindario dentro de la MISMA ciudad) sigue siendo
// una sugerencia legítima y se mantiene.
