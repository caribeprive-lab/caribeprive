...
export const zones = [
  {
    ...
    description: {
      es: "Anah es un desarrollo de condominios en el centro de Playa del Carmen, con roof top, gimnasio, coworking y seguridad 24 horas.",
      en: "Anah is a condominium development in downtown Playa del Carmen, with a roof top, gym, coworking space and 24-hour security.",
    },
