...
export const zones = [
  {
    slug: "prolongacion-la-luna",
    name: "Prolongación La Luna",
    city: "Cancún",
    region: { es: "Prolongación La Luna · Cancún", en: "Prolongación La Luna · Cancún" },
    description: {
      es: "Prolongación La Luna es una zona en crecimiento de Cancún, con desarrollos de departamentos de nueva generación y buena conectividad.",
      en: "Prolongación La Luna is a fast-growing area of Cancún, with new-generation apartment developments and good connectivity.",
    },
  ...
  },
  {
    ...
    description: {
      es: "Playa del Carmen es el corazón de la Riviera Maya: playas de arena blanca, la Quinta Avenida y uno de los mercados de renta vacacional más dinámicos del Caribe Mexicano.",
      en: "Playa del Carmen is the heart of the Riviera Maya: white-sand beaches, Quinta Avenida and one of the most dynamic vacation-rental markets in the Mexican Caribbean.",
    },
  ...
  },
  {
    ...
    description: {
      es: "Cumbres es un fraccionamiento residencial de Cancún, con condominios amenidades como alberca, gimnasio, spa y cancha de pádel.",
      en: "Cumbres is a residential subdivision in Cancún, with condominiums featuring amenities such as a pool, gym, spa and padel court.",
    },
  ...
  },
  {
    ...
    name: "Zona Hotelera",
    city: "Cancún",
    region: { es: "Zona Hotelera · Cancún", en: "Hotel Zone · Cancún" },
    description: {
      es: "La Zona Hotelera de Cancún es la franja frente al mar Caribe, con playas de arena blanca, hoteles de lujo y los desarrollos residenciales de mayor exclusividad de la ciudad.",
      en: "Cancún's Hotel Zone is the strip along the Caribbean Sea, with white-sand beaches, luxury hotels and the city's most exclusive residential developments.",
    },
    heroImage: "/propiedades/departamento-punta-cancun/vista-alberca-01.webp",
  },
  {
    slug: "puerto-morelos",
    name: "Puerto Morelos",
  ...
  },
  {
    ...
    description: {
      es: "Isla Dorada es un residencial de casas frente a canal en Cancún, con acceso directo por muelle privado, casa club, gimnasio, spa y cancha de tenis.",
      en: "Isla Dorada is a canal-front house community in Cancún, with direct private dock access, a clubhouse, gym, spa and tennis court.",
    },
