...
export const developments = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    operation: "venta",
    saleType: "preventa",
    // Puerto 369 comercializa LOTES (unifamiliares, multifamiliares y
    // comerciales) — "multifamiliar" describe la zonificación del lote, no
    // unidades de departamento terminadas en venta. Confirmado 2026-08-12:
    // no debe aparecer en búsquedas de category:"departamento".
    category: ["lote"],
    city: "Puerto Morelos",
    zoneSlug: "puerto-morelos",
    developmentSlug: null,
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    type: { es: "Departamentos · 1, 2 y 3 recámaras", en: "Condominiums · 1, 2 & 3 bedrooms" },
    appreciation: null,
    ...
    price: {
      amount: 4100000,
      currency: "MXN",
      display: { es: "Desde $4,100,000 MXN", en: "From $4,100,000 MXN" },
    },
    deliveryStatus: { es: "Preventa", en: "Pre-sale" },
    projectType: { es: "Departamentos", en: "Condominiums" },
    ...
    developer: {
      ...
      logo: "https://greenwood.com.mx/wp-content/uploads/2024/01/Logo-tierra-y-armonia-.png",
      description: {
        es: "Tierra y Armonía es una desarrolladora mexicana con más de 50 años de experiencia y más de 200 proyectos inmobiliarios construidos en todo el país, enfocada en plusvalía, belleza arquitectónica y comunidades con amenidades excepcionales.",
        en: "Tierra y Armonía is a Mexican developer with over 50 years of experience and more than 200 real estate projects built nationwide, focused on appreciation, architectural beauty and communities with exceptional amenities.",
      },
    },
    ...
    amenities: [
      {
        id: "acuatico",
        title: { es: "Alberca infinity y jacuzzi", en: "Infinity pool & jacuzzi" },
        desc: { es: "Alberca infinity en el roof top con vista al horizonte y jacuzzi privado, para desconectar sin salir de casa.", en: "Rooftop infinity pool with horizon views and a private jacuzzi, to unwind without leaving home." },
        image: "https://greenwood.com.mx/wp-content/uploads/2025/09/1.-INFINITY-POOL.jpg",
      },
      {
        id: "deporte",
        title: { es: "Deporte y movimiento", en: "Sport & movement" },
        desc: { es: "Gimnasio equipado, cancha de pádel, cancha de pickleball/tenis y mini golf, dentro del Green Park central de 13,000 m².", en: "Equipped gym, padel court, pickleball/tennis court and mini golf, inside the 13,000 m² central Green Park." },
        image: "https://greenwood.com.mx/wp-content/uploads/2025/09/3.-GYM-FITNESS-CENTER.jpg",
      },
      {
        id: "social",
        title: { es: "Vida social", en: "Social life" },
        desc: { es: "Social lounge, sports bar, sky bar y cocina social para compartir cada momento con vecinos y amigos.", en: "Social lounge, sports bar, sky bar and social kitchen to share every moment with neighbors and friends." },
        image: "https://greenwood.com.mx/wp-content/uploads/2025/09/1.-SOCIAL-LOUNGE.jpg",
      },
      {
        id: "familia",
        title: { es: "Familia y bienestar", en: "Family & wellness" },
        desc: { es: "Kids club, yoga zone, pet park y área de picnic, pensados para todas las edades y todos los ritmos de vida.", en: "Kids club, yoga zone, pet park and picnic area, designed for every age and every pace of life." },
        image: "https://greenwood.com.mx/wp-content/uploads/2025/09/4.-KIDS-CLUB.jpg",
      },
    ],
    ...
    location: {
      lat: 21.1150721,
      lng: -86.8384062,
      address: "Fraccionamiento Cumbres, Cancún, Quintana Roo, México",
      description: {
        es: "Greenwood se ubica en Cumbres, una de las zonas de mayor conectividad de Cancún: a 6 minutos de la playa, 10 minutos de la Zona Hotelera, 12 minutos del aeropuerto y 14 minutos del Puerto de Cancún.",
        en: "Greenwood is located in Cumbres, one of Cancún's best-connected areas: 6 minutes from the beach, 10 minutes from the Hotel Zone, 12 minutes from the airport and 14 minutes from the Port of Cancún.",
      },
    },

    cardImage: "https://greenwood.com.mx/wp-content/uploads/2024/01/Imagen-edificio-1.jpg",
    heroImage: "https://greenwood.com.mx/wp-content/uploads/2025/09/1.-INFINITY-POOL.jpg",
    gallery: [
      "https://greenwood.com.mx/wp-content/uploads/2024/03/home-1.jpg",
      "https://greenwood.com.mx/wp-content/uploads/2025/09/1.-SOCIAL-LOUNGE.jpg",
      "https://greenwood.com.mx/wp-content/uploads/2025/09/4.-JACUZZI.jpg",
    ],

    cardDesc: {
      es: "5 etapas dentro de un plan maestro con Green Park de 13,000 m² y más de 30 amenidades. Departamentos de 1, 2 y 3 recámaras desde $4,100,000 MXN.",
      en: "5 stages within a master plan with a 13,000 m² Green Park and 30+ amenities. 1, 2 and 3-bedroom units from $4,100,000 MXN.",
    },
    headline: {
      es: "Un hábitat natural en el corazón de Cancún, diseñado para días memorables.",
      en: "A natural habitat in the heart of Cancún, designed for memorable days.",
    },
    body: {
      es: [
        "Greenwood es el nuevo proyecto de Tierra y Armonía (+50 años de experiencia) diseñado por Artigas Arquitectos, en Cumbres, Cancún.",
        "5 etapas dentro de un plan maestro integral, con un Green Park central de 13,000 m² y más de 30 amenidades sociales, deportivas y de bienestar. Departamentos de 1, 2 y 3 recámaras, ideales para vivir o generar ingresos con renta vacacional.",
      ],
      en: [
        "Greenwood is the new project by Tierra y Armonía (50+ years of experience) designed by Artigas Arquitectos, in Cumbres, Cancún.",
        "5 stages within a comprehensive master plan, with a 13,000 m² central Green Park and over 30 social, sports and wellness amenities. 1, 2 and 3-bedroom units, ideal to live in or generate income through vacation rentals.",
      ],
    },
    stats: [
      { value: "5", label: { es: "Etapas", en: "Stages" } },
      { value: "30+", label: { es: "Amenidades", en: "Amenities" } },
      { value: "13,000m²", label: { es: "Green Park central", en: "Central Green Park" } },
      { value: "6 min", label: { es: "De la playa", en: "From the beach" } },
    ],
    features: [
      { es: "Diseñado por Artigas Arquitectos", en: "Designed by Artigas Arquitectos" },
      { es: "Desarrollado por Tierra y Armonía (+50 años)", en: "Developed by Tierra y Armonía (50+ years)" },
      { es: "Departamentos de 1, 2 y 3 recámaras", en: "1, 2 & 3-bedroom units" },
      { es: "Green Park central de 13,000 m²", en: "13,000 m² central Green Park" },
      { es: "15% de enganche con descuento de preventa", en: "15% down payment with pre-sale discount" },
      { es: "5 planes de financiamiento disponibles", en: "5 available financing plans" },
      { es: "A 6 min de la playa y 12 min del aeropuerto", en: "6 min from the beach, 12 min from the airport" },
      { es: "Ideal para renta vacacional", en: "Ideal for vacation rentals" },
    ],
  },
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    zone: "Prolongación La Luna",
    region: { es: "Prolongación La Luna · Cancún", en: "Prolongación La Luna · Cancún" },
    type: { es: "Departamentos · 1, 2 y 3 recámaras", en: "Condominiums · 1, 2 & 3 bedrooms" },
    appreciation: null,
    ...
    price: {
      amount: 4900000,
      currency: "MXN",
      display: { es: "Desde $4,900,000 MXN", en: "From $4,900,000 MXN" },
    },
    deliveryStatus: { es: "Preventa · Escrituración 2025", en: "Pre-sale · Titling 2025" },
    projectType: { es: "Departamentos", en: "Condominiums" },

    // ── Desarrollador ────────────────────────────────────────────
    developer: {
      name: "Onix Living",
      logo: "https://onixliving.mx/wp-content/uploads/2022/03/OL_LOGO-25.png.webp",
      description: {
        es: "Onix Living es una desarrolladora enfocada exclusivamente en el Caribe Mexicano (Cancún y Tulum), con más de 80 profesionales y más de 850 unidades entregadas en los últimos 2 años. Idea, construye y comercializa cada proyecto sin intermediarios.",
        en: "Onix Living is a developer focused exclusively on the Mexican Caribbean (Cancún and Tulum), with over 80 professionals and more than 850 units delivered in the last 2 years. They design, build and sell every project without intermediaries.",
      },
    },
    ...
    amenities: [
      {
        id: "acuatico",
        title: { es: "Alberca infinity y rooftop", en: "Infinity pool & rooftop" },
        desc: { es: "Alberca infinity en el roof top, con asadores y camastros para disfrutar el atardecer sin salir del edificio.", en: "Rooftop infinity pool, with grills and loungers to enjoy the sunset without leaving the building." },
        image: "https://koatowers.com/wp-content/uploads/2024/06/Copia-de-ROOFTOP_02-1-scaled.jpg",
      },
      {
        id: "deporte",
        title: { es: "Deporte y bienestar", en: "Sport & wellness" },
        desc: { es: "Gimnasio climatizado, cancha de pádel y zona de yoga, para mantenerte activo sin salir de casa.", en: "Air-conditioned gym, padel court and a yoga zone, to stay active without leaving home." },
        image: "https://koatowers.com/wp-content/uploads/2024/06/Copia-de-ROOFTOP_02-1-scaled.jpg",
      },
      {
        id: "social",
        title: { es: "Salón de usos múltiples", en: "Multipurpose lounge" },
        desc: { es: "Un espacio versátil para eventos, reuniones y convivencia entre vecinos.", en: "A versatile space for events, meetings and time with neighbors." },
        image: "https://koatowers.com/wp-content/uploads/2024/06/Copia-de-USOS_MULTIPLES_01-scaled.jpg",
      },
      {
        id: "familia",
        title: { es: "Ludoteca", en: "Kids playroom" },
        desc: { es: "Un espacio seguro y equipado donde los más pequeños pueden aprender y jugar.", en: "A safe, fully equipped space where kids can play and learn." },
        image: "https://koatowers.com/wp-content/uploads/2024/06/Copia-de-LUDOTECA_01-scaled.jpg",
      },
    ],
    ...
    location: {
      lat: 21.1113308,
      lng: -86.8571864,
      address: "Av. Prolongación La Luna esq. Calle Naranjo, 77533, Cancún, Quintana Roo, México",
      description: {
        es: "Koa Towers se ubica sobre Av. Prolongación La Luna, esquina con Calle Naranjo, justo junto a Areka Towers, en una de las zonas de mayor crecimiento de Cancún.",
        en: "Koa Towers is located on Av. Prolongación La Luna, at the corner of Calle Naranjo, right next to Areka Towers, in one of Cancún's fastest-growing areas.",
      },
    },

    cardImage: "https://koatowers.com/wp-content/uploads/2024/06/Copia-de-USOS_MULTIPLES_01-scaled.jpg",
    heroImage: "https://koatowers.com/wp-content/uploads/2024/06/Copia-de-ROOFTOP_02-1-scaled.jpg",
    gallery: [
      "https://koatowers.com/wp-content/uploads/2024/06/Copia-de-LUDOTECA_01-scaled.jpg",
      "https://koatowers.com/wp-content/uploads/2023/11/KOA_Ficha_2Bis_ESP-scaled-e1699141141337.jpg",
      "https://koatowers.com/wp-content/uploads/2023/04/layout-17-2.png",
    ],

    cardDesc: {
      es: "Departamentos de 1, 2 y 3 recámaras con amenidades en rooftop, sobre Av. Prolongación La Luna. Desde $4,900,000 MXN, escrituración garantizada en 2025.",
      en: "1, 2 and 3-bedroom units with rooftop amenities, on Av. Prolongación La Luna. From $4,900,000 MXN, guaranteed titling in 2025.",
    },
    headline: {
      es: "Invierte hoy, asegura tu patrimonio en Cancún.",
      en: "Invest today, secure your future in Cancún.",
    },
    body: {
      es: [
        "Koa Towers es un desarrollo de Onix Living sobre Av. Prolongación La Luna, esquina con Calle Naranjo, junto a Areka Towers, en Cancún.",
        "Departamentos de 1, 2 y 3 recámaras con terraza y cuarto de lavado; los modelos más grandes incluyen 2.5 baños y 2 cajones de estacionamiento. Escrituración garantizada en 2025, con apartado desde $50,000 MXN y enganches desde el 30%.",
        "El desarrollo cuenta con alberca infinity y asadores en el roof top, gimnasio climatizado, cancha de pádel, ludoteca y zona de yoga.",
      ],
      en: [
        "Koa Towers is a development by Onix Living on Av. Prolongación La Luna, at the corner of Calle Naranjo, next to Areka Towers, in Cancún.",
        "1, 2 and 3-bedroom units with a terrace and laundry room; the larger models include 2.5 bathrooms and 2 parking spaces. Guaranteed titling in 2025, with reservations from $50,000 MXN and down payments from 30%.",
        "The development features a rooftop infinity pool and grills, an air-conditioned gym, a padel court, a kids playroom and a yoga zone.",
      ],
    },
    stats: [
      { value: "1-3", label: { es: "Recámaras", en: "Bedrooms" } },
      { value: "2025", label: { es: "Escrituración", en: "Titling" } },
      { value: "30%", label: { es: "Enganche desde", en: "Down payment from" } },
      { value: "$50,000", label: { es: "Apartado desde (MXN)", en: "Reservation from (MXN)" } },
    ],
    features: [
      { es: "Departamentos de 1, 2 y 3 recámaras", en: "1, 2 & 3-bedroom units" },
      { es: "Escrituración garantizada en 2025", en: "Guaranteed titling in 2025" },
      { es: "Apartado desde $50,000 MXN", en: "Reservation from $50,000 MXN" },
      { es: "Enganches desde 30%", en: "Down payments from 30%" },
      { es: "Alberca infinity en rooftop con asadores", en: "Rooftop infinity pool with grills" },
      { es: "Gimnasio climatizado y cancha de pádel", en: "Air-conditioned gym and padel court" },
      { es: "Ludoteca y zona de yoga", en: "Kids playroom and yoga zone" },
      { es: "Junto a Areka Towers", en: "Next to Areka Towers" },
    ],
  },
];
