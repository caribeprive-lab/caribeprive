...
export const developments = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    cardDesc: {
      es: "113 unidades boutique frente a la Marina Puerto Cancún. 13 amenidades, muelle privado y últimas unidades disponibles.",
      en: "113 boutique units facing the Puerto Cancún Marina. 13 amenities, private dock and final units available.",
    },
    headline: {
    ...
    body: {
      es: [
        ...
        "Departamentos de 2 y 3 recámaras con acabados de lujo, muelle privado, acceso directo a Plaza Puerto Cancún y 13 amenidades pensadas para una vida de marina.",
      ],
      en: [
        ...
        "2 and 3-bedroom units with luxury finishes, private dock, direct access to Plaza Puerto Cancún and 13 amenities designed for marina living.",
      ],
    },
    stats: [
      { value: "113", label: { es: "Unidades boutique", en: "Boutique units" } },
      { value: "13", label: { es: "Amenidades", en: "Amenities" } },
    ...
    features: [
      ...
      { es: "Departamentos de 2 y 3 recámaras", en: "2 and 3-bedroom units" },
