...
export const properties = [
  ...
  },
  {
    ...
    bedrooms: 3,
    bathrooms: 3.5,
    area: { built: 185, lot: 105, unit: "m2" },
    status: "disponible",
    featured: false,
    seo: { title: null, description: null },
    ...
    zone: "Arbolada",
    region: { es: "Arbolada · Cancún", en: "Arbolada · Cancún" },
    type: { es: "Casa · Nueva, esquina", en: "House · New, corner lot" },
    appreciation: null,
    ...
    price: {
      amount: 4400000,
      currency: "MXN",
      display: { es: "$4,400,000 MXN", en: "$4,400,000 MXN" },
    },
    deliveryStatus: { es: "Entrega Inmediata", en: "Immediate Delivery" },
    projectType: { es: "Casa", en: "House" },

    // ── Imágenes ─────────────────────────────────────────────────
    cardImage: "/propiedades/casa-tzalam/sala-01.webp",
    heroImage: "/propiedades/casa-tzalam/fachada-01.webp",
    gallery: [
      "/propiedades/casa-tzalam/sala-02.webp",
      "/propiedades/casa-tzalam/recamara-01.webp",
      "/propiedades/casa-tzalam/recamara-02.webp",
      "/propiedades/casa-tzalam/recamara-03.webp",
      "/propiedades/casa-tzalam/recamara-04.webp",
      "/propiedades/casa-tzalam/bano-01.webp",
      "/propiedades/casa-tzalam/bano-02.webp",
      "/propiedades/casa-tzalam/closet-01.webp",
    ],

    cardDesc: {
      es: "Casa nueva de 3 recámaras y 3.5 baños, en lote de esquina, dentro de Residencial Arbolada, Cancún.",
      en: "New 3-bedroom, 3.5-bathroom house on a corner lot, inside Residencial Arbolada, Cancún.",
    },
    headline: {
      es: "Casa nueva en esquina, lista para hacerla tuya.",
      en: "New corner-lot house, ready to make your own.",
    },
    body: {
      es: [
        "Casa Tzalam es una casa nueva dentro de Residencial Arbolada, Cancún, en un lote de esquina con 185 m² de construcción sobre un terreno de 105 m².",
        "3 recámaras y 3.5 baños, con jacuzzi y 2 lugares de estacionamiento. Se entrega sin muebles, con mantenimiento incluido.",
        "El residencial cuenta con parque social y seguridad 24 horas.",
      ],
      en: [
        "Casa Tzalam is a new house inside Residencial Arbolada, Cancún, on a corner lot with 185 m² of construction on a 105 m² lot.",
        "3 bedrooms and 3.5 bathrooms, with a jacuzzi and 2 parking spaces. Delivered unfurnished, with maintenance fees included.",
        "The residential community features a social park and 24-hour security.",
      ],
    },
    stats: [
      { value: "3", label: { es: "Recámaras", en: "Bedrooms" } },
      { value: "3.5", label: { es: "Baños", en: "Bathrooms" } },
      { value: "185m²", label: { es: "Construcción", en: "Built area" } },
      { value: "105m²", label: { es: "Terreno", en: "Lot size" } },
    ],
    features: [
      { es: "Casa nueva", en: "New house" },
      { es: "Lote de esquina", en: "Corner lot" },
      { es: "Jacuzzi", en: "Jacuzzi" },
      { es: "2 lugares de estacionamiento", en: "2 parking spaces" },
      { es: "Mantenimiento incluido", en: "Maintenance fees included" },
      { es: "Se entrega sin muebles", en: "Delivered unfurnished" },
      { es: "Parque social", en: "Social park" },
      { es: "Seguridad 24 horas", en: "24-hour security" },
    ],
  },
];
