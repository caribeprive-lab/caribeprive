...
export const properties = [
  ...
  {
    slug: "departamento-cancun-towers-ii",
    kind: "property",
    published: true,
    name: "Cancún Towers II",
    ...
    // ── Imágenes ─────────────────────────────────────────────────
    cardImage: "/propiedades/departamento-cancun-towers-ii/balcon-01.webp",
    heroImage: "/propiedades/departamento-cancun-towers-ii/comedor-vista-01.webp",
    gallery: [
      "/propiedades/departamento-cancun-towers-ii/recamara-01.webp",
      "/propiedades/departamento-cancun-towers-ii/recamara-02.webp",
      "/propiedades/departamento-cancun-towers-ii/cocina-01.webp",
      "/propiedades/departamento-cancun-towers-ii/comedor-01.webp",
      "/propiedades/departamento-cancun-towers-ii/sala-01.webp",
      "/propiedades/departamento-cancun-towers-ii/sala-02.webp",
      "/propiedades/departamento-cancun-towers-ii/estancia-01.webp",
    ],

    cardDesc: {
      es: "Departamento de 2 recámaras y 168 m² con vista al mar y campo de golf, en Puerto Cancún.",
      en: "2-bedroom, 168 m² apartment with ocean and golf course views, in Puerto Cancún.",
    },
    headline: {
      es: "Vive con vista al mar y al campo de golf, en la zona de mayor plusvalía de Cancún.",
      en: "Live with ocean and golf course views, in Cancún's highest-appreciation area.",
    ...
    body: {
      es: [
        "Departamento Cancún Towers se ubica en Puerto Cancún, la zona residencial de mayor plusvalía de Cancún, con 168 m² de construcción y vista al mar y al campo de golf.",
        "2 recámaras y 2 baños completos, 1 lugar de estacionamiento, bodega, cerraduras electrónicas y acceso directo al ascensor.",
        "El edificio cuenta con alberca, jardín, spa, cancha de tenis y gimnasio.",
      ],
      en: [
        "Departamento Cancún Towers is located in Puerto Cancún, Cancún's highest-appreciation residential area, with 168 m² of construction and ocean and golf course views.",
        "2 bedrooms and 2 full bathrooms, 1 parking space, a storage unit, electronic locks and direct elevator access.",
        "The building features a pool, garden, spa, tennis court and gym.",
      ],
    },
    stats: [
  ...
  },
  {
    ...
    body: {
      es: [
        "Casa Ciruelo se ubica en Residencial Arbolada, Cancún, distribuida en 3 niveles.",
        "4 recámaras y 4 baños, 2 lugares de estacionamiento y cuarto de lavado. Se entrega sin muebles.",
      ],
      en: [
        "Casa Ciruelo is located in Residencial Arbolada, Cancún, spread across 3 levels.",
    ...
    stats: [
      ...
      { value: "2", label: { es: "Estacionamientos", en: "Parking spaces" } },
      { value: "3", label: { es: "Niveles", en: "Levels" } },
    ],
    features: [
