...
export const properties = [
  ...
  },
  {
    ...
    cardDesc: {
      es: "Departamento de 3 recámaras y cuarto de servicio en el piso 11, con vista panorámica, en venta o renta en Central Park Towers, Cancún.",
      en: "3-bedroom apartment with staff room on the 11th floor, with panoramic views, for sale or rent in Central Park Towers, Cancún.",
    },
    headline: {
    ...
    body: {
      es: [
        "Departamento 1101 se ubica en el piso 11 de Central Park Towers, en la zona del Malecón Cancún, con vista panorámica hacia la Zona Hotelera y los manglares circundantes.",
      ...
      en: [
        "Departamento 1101 is located on the 11th floor of Central Park Towers, in the Malecón Cancún area, with panoramic views toward the Hotel Zone and the surrounding wetlands.",
    ...
    stats: [
      ...
      { value: "Panorámica", label: { es: "Vista", en: "View" } },
    ],
    features: [
